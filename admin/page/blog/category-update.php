...
if(isset($_POST["update"])){
    ...
    mysqli_query($conn,"UPDATE category set category_name = '$name', icon = '$icon' WHERE id = '$category_id'");
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form role="form" action="" method="post">
                            ...
                            <input name="id_category" type="hidden" value="<?php echo $row_edit["id"] ?>" />
                        </form>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php while($row_category = mysqli_fetch_array($category)){?>
                            <tr>
                                ...
                                <td><span class="<?php echo $row_category["icon"]?>"> <?php echo $row_category["icon"]?></span></td>
