...
if(isset($_POST["update"])){
    ...
    $reply = $_POST["reply"];
    $status = $_POST["status"];
    mysqli_query($conn, "UPDATE comment SET post_id= '$post_id', name = '$name', reply = '$reply',
...
$comment = mysqli_query($conn,"SELECT comment.*, post.title FROM comment,post WHERE comment.post_id = post.id
                                AND comment.status = '1' ORDER BY comment.id desc");
?>
<div class="row">
    <div class="col-lg-12">
