...
if(isset($_POST["update"])){
    ...
    if($file_name=="" || empty($file_name)){
        mysqli_query($conn,"UPDATE post set category_id='$category_id', title = '$title', description = '$description'
                            WHERE id = '$id_post'");
    }else{
        move_uploaded_file/**maksudnya di move?**/($tmp_name, "../images/".$file_name);
        mysqli_query($conn,"UPDATE post set category_id='$category_id', title = '$title', description = '$description',
...
$post = mysqli_query($conn, "SELECT post.*, category.category_name FROM post, category
                    ...
                    <div class="col-lg-12">
                        <form role="form" action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    ...
                                    <?php while($row_cat = mysqli_fetch_array($category)){?>
                                        <option <?php echo $row_edit["category_id"]==$row_cat["id"]? "selected='selected'" /**maksud??**/: ""; ?>
                            ...
                            <div class="form-group">
                                ...
                                <p><img src="../images/<?php echo $row_edit["image"] ?>" width="88" /></p><?php } ?>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php while($row_post = mysqli_fetch_array($post)){?>
                            <tr>
                                ...
                                <img src="../images/<?php echo $row_post["image"]?>" width="88" class="img-responsive" /><?php } ?></td>
